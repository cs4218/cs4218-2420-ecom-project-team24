...
jest.spyOn(categoryModel, 'findOne').mockImplementation(() => jest.fn());
jest.spyOn(categoryModel, 'findByIdAndUpdate').mockImplementation(() => jest.fn());
jest.spyOn(categoryModel, 'find').mockImplementation(() => jest.fn());
jest.spyOn(categoryModel, 'findByIdAndDelete').mockImplementation(() => jest.fn());
jest.spyOn(categoryModel.prototype, 'save').mockImplementation(() => jest.fn());
